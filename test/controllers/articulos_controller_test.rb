...
class ArticulosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create articulo" do
    assert_difference("Articulo.count") do
      post articulos_url, params: { articulo: { categoria_id: @articulo.categoria_id, contenido: @articulo.contenido, fecha_creacion: @articulo.fecha_creacion, publicado: @articulo.publicado, titulo: @articulo.titulo, usuario_id: @articulo.usuario_id } }
    end
  ...
  test "should update articulo" do
    patch articulo_url(@articulo), params: { articulo: { categoria_id: @articulo.categoria_id, contenido: @articulo.contenido, fecha_creacion: @articulo.fecha_creacion, publicado: @articulo.publicado, titulo: @articulo.titulo, usuario_id: @articulo.usuario_id } }
